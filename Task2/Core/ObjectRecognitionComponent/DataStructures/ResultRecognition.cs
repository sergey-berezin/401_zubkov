...
namespace Core.ObjectRecognitionComponent.DataStructures {
    public class ResultRecognition {
        ...
        public ResultRecognition(string image_path, float[] bbox, string label, float confidence) {
        ...
        public ResultRecognition(string image_path, YoloV4Result yolovr_result) {
            ImagePath = image_path;
